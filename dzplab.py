...
def installJDownloader():
    if checkAvailable("/root/.JDownloader/JDownloader.jar"):
        ...
        runSh(
            "wget -q https://xiptv.github.io/dzp/resources/packages/jdownloader/sevenzipjbinding1509.jar -O /root/.JDownloader/libs/sevenzipjbinding1509.jar"
        )
        runSh(
            "wget -q https://xiptv.github.io/dzp/resources/packages/jdownloader/sevenzipjbinding1509Linux.jar -O /root/.JDownloader/libs/sevenzipjbinding1509Linux.jar"
        )
